DROP PROCEDURE IF EXISTS ubigeo_direccion_sinonimo_save;
SELECT 'CREATE PROCEDURE ubigeo_direccion_sinonimo_save' AS 'MENSAJE';
DELIMITER $$ 

CREATE PROCEDURE ubigeo_direccion_sinonimo_save(
    in_id BIGINT
