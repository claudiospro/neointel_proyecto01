...
DROP PROCEDURE IF EXISTS ubigeo_direccion_tipo_sinonimo_parent_set;
DELIMITER $$ 

CREATE PROCEDURE ubigeo_direccion_tipo_sinonimo_parent_set(
  in_id BIGINT
)
BEGIN
    ...
    IF ou_parent_id = in_id THEN
       SELECT ou_parent_id;
    ELSE
       CALL ubigeo_direccion_tipo_sinonimo_parent_set(ou_parent_id);
    END IF
    ;
