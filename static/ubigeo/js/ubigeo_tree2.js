$(document).ready(function() {
    ...
    // ---------------------------------------------------------- funciones
    function ubigeo_tree_list(parent) {
        enviar = {
            'id': parent
        }
        element_simple( './process/ajax/tree/ubigeo_tree2_onload_treeUl.php'
                        , prefixId+'list ol#parent_item_'+enviar.id
                        , enviar
                      );
}
    function ubigeo_tree_list_a(item) {
        ...
        // a(display);
        ubigeo_tree_list(item.attr('codigo'));
        if (display == 'block') {
    ...
    function ubigeo_tree_list_a_edit(item) {
	    ...
	    success: function(data) {
                ...
                ubigeo_tree_edit_sinonimo_clear();
                $(prefixId+'edit_modal_sinonimo_nombre').val(json.nombre);
    ...
    function ubigeo_tree_edit_sinonimo_save() {
        ...
        if (enviar.sinonimo_nombre.trim()!='') {
            ...
            flag_simple('./process/ajax/save/ubigeo_tree_sinonimo_click_save.php', enviar, flag);
            ubigeo_tree_edit_sinonimo_clear();
